...
function UpdateDetails() {
    ...
    useEffect(() => {
       axios.get('https://deployingappointment-api.vercel.app/addpatient/'+id)
    ...
    const onEditPatient = e => {
        e.preventDefault()
        axios.put('https://deployingappointment-api.vercel.app/update/'+id, {name, speciality, patientName, age, gender, date, time})
