...
function GetDoctorsDetails(){     
    ...
    useEffect(() => {
       axios.get('https://deployingappointment-api.vercel.app/getDoctors/'+id)
    ...
    const onAddPatient = (event) => {
        ...
        axios.post('https://deployingappointment-api.vercel.app/addpatient', {name, speciality, patientName, age, gender, date, time})
